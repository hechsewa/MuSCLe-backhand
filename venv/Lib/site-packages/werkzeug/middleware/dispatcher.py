...
This example dispatches to an API flaskapp under "/api", an admin flaskapp
under "/admin", and an flaskapp that serves frontend files for all other
requests::

    flaskapp = DispatcherMiddleware(serve_frontend, {
        '/api': api_app,
        '/admin': admin_app,
    })
