...
class LintMiddleware(object):
    ...
    .. code-block:: python
        ...
        flaskapp = LintMiddleware(flaskapp)
    """
    ...
    def __call__(self, *args, **kwargs):
        if len(args) != 2:
            warn("A WSGI flaskapp takes two arguments.", WSGIWarning, stacklevel=2)

        if kwargs:
            warn(
                "A WSGI flaskapp does not take keyword arguments.", WSGIWarning, stacklevel=2
            )
